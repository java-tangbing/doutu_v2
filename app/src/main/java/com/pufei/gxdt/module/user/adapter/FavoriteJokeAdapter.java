...
public class FavoriteJokeAdapter extends XRecyclerView.Adapter<XRecyclerView.ViewHolder> {
    private List<MyImagesBean.ResultBean> list;
    private Context mcontext;
    private int IMAGE_SIZE ;
    public FavoriteJokeAdapter(Context context, List<MyImagesBean.ResultBean> list, int IMAGE_SIZE) {//获取数据源
